        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 mt-4">
            <div class="card brder-dark">
              <img src="../../penjual/assets/img/barang/<?php echo $result['gmbr'] ?>" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title font-weight-bold"><?php echo $result['nama_barang'] ?> - <?php echo $result['merk'] ?></h5>
               <label class="card-text harga"><strong>Rp.</strong> <?php echo number_format($result['harga_jual']); ?></label><br>
                <a href="beli.php?id_barang=<?php echo $result['id_barang']; ?>" class="btn btn-success btn-sm btn-block ">BELI</a>
              </div>
            </div>
          </div>
          <?php endforeach; ?>
