							...
							<div class="col-sm-3">
								<div class="panel panel-primary">
									...
									<div class="panel-footer">
										<form method="POST" action="fungsi/edit/editfoto.php?gambar=user" enctype="multipart/form-data">
								...
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										<div class="box-content">
											<form class="form-horizontal" method="POST" action="fungsi/edit/editfoto.php?profil=edit" enctype="multipart/form-data">
												<fieldset>
